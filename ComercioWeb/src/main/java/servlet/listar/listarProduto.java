...
public class listarProduto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            ...
            if (status != null) {
                if (status.equals("OK")) {
                     RequestDispatcher rd = request.getRequestDispatcher("produto.jsp?status");
                     rd.forward(request, response);  
                }
       
               else if (editar.equals("OK")) {
               RequestDispatcher rd = request.getRequestDispatcher("produto.jsp?editar");
                     rd.forward(request, response);  
              
                   
                }
                   else if (excluir.equals("OK")) {
                RequestDispatcher rd = request.getRequestDispatcher("produto.jsp?excluir");
                     rd.forward(request, response);   
