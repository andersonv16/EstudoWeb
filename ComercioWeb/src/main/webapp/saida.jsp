            ...
            <article class="container ">
                <div class="row">
                    ...
                    <div class="col-md-12 bg-white border ">
                      <div id="minhaDiv">
                        <form  class="row" action="cadastrarSaidaServlet" accept-charset="character_set" method="post">
                    ...
                    for(int i = 0; i < listaVendedor.size(); i++){
                       out.println("<option value='"+listaVendedor.get(i).getCpf()+"'>");
                        ...
                        %>    
                          ...
                          <div id="divEditar">
                            <form  class="row" action="editarSaidaServlet" accept-charset="character_set" method="post">
                             <fieldset class="mt-5 col-md-10 "> 
                       ...
                       out.println("<option value='"+listaVendedor.get(i).getCpf()+"'>");
                        ...
                        %>    
                            ...
                            <div class="mt-5">
                                ...
                                <form id="excluirform" name="excluirform" " class="float-start" action="excluirSaidaServlet" method="post">
                 ...
                 ArrayList<Saida> listaSaida = new SaidaDAO().getSaidas();
                    ...
                    for(int i = 0; i < listaSaida.size(); i++){
                        out.println("<tr>");
                        out.println("<td><input class='editar' type='checkbox' id='" + (i+1) + "' value='" + listaSaida.get(i).getId() + "' ></td>");
                        out.println("<th scope='row'>" + listaSaida.get(i).getId()+"</th >");
                        out.println("<td>" + listaSaida.get(i).getNome() + "</td>");
                        out.println("<td>" + listaSaida.get(i).getCod_produto()+ "</td>");
                        out.println("<td>" + listaSaida.get(i).getCliente()+ "</td>");
                        out.println("<td>" + listaSaida.get(i).getQuantidade()+ "</td>");
                        out.println("<td>" + listaSaida.get(i).getData()+ "</td>");
                        out.println("<td>" + listaSaida.get(i).getValor()+ "</td>");
                        out.println("<td>" + listaSaida.get(i).getVendedor()+ "</td>");
                        out.println("</tr>");
                    }
%> 
                        </tbody>
