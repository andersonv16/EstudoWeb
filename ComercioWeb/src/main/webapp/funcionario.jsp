                        ...
                        <article class="container ">
                            <div class="row">
                                ...
                                <div class="col-md-12 bg-white border ">
                                    ...
                                    <div id="divEditar">
                                        <form class="row" action="editarFuncionarioServlet" accept-charset="character_set" method="post">
                                            <fieldset class="col-md-6 p-3">
                                                <legend class="text-center fw-bolder text-success">Dados Pessoais</legend>
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <form id="excluirform" name="excluirform" " class="float-start" action="excluirFuncionarioServlet" method="post">
                                    ...
                                    <table id="tabelaFuncionario" class="table mt-5 table-striped table-hover table-responsive-lg">  
                                        ...
                                        <tbody>
                                            <%   
                                                ...
                                                ArrayList<Funcionario> lista = new FuncionarioDAO().getFuncionarios();
