            ...
            <article class="container ">
                <div class="row">
                    ...
                    <div class="col-md-12 bg-white border ">
                      <div id="minhaDiv">
                        <form  class="row" action="<c:url value="cadastrarEntradaServlet"/> " accept-charset="character_set" method="post">
                    ...
                    for(int i = 0; i < lista.size(); i++){
                       out.println("<option value='"+lista.get(i).getId()+"'>");
                        ...
                        %>    
                          ...
                          <div id="divEditar">
                            <form  class="row" action="<c:url value="editarEntradaServlet"/>" accept-charset="character_set" method="post">
                             <fieldset class="mt-5 col-md-10 "> 
                    ...
                    for(int i = 0; i < lista.size(); i++){
                       out.println("<option value='"+lista.get(i).getId()+"'>");
                        ...
                        %>    
                           ...
                           <br>
                            ...
                            <div class="mt-5">
                                ...
                                <form id="excluirform" name="excluirform" " class="float-start" action="<c:url value="excluirEntradaServlet"/>" method="post">
                        ...
                        <tbody>
                                <c:forEach items="${listarEntrada}" var="listas">
                                <tr>
                            <td><input class='editar' type='checkbox' id="" value='${listas.nome_produto}'></td>
                                <th>${listas.id}</th>
                                <td>${listas.nome_produto}</td>
