        ...
        <div id="main">
          <div class="inner">
            ...
            <section class="services">
              <div class="container-fluid">
                <div class="row">
                  <a href="entrada.jsp" class="col-md-4">
                    <div class="service-item first-item">
                      <div class="icon"></div>
                      <h4>Entrada de Produtos</h4>
                    </div>
                  </a>
                     <a href="saida.jsp" class="col-md-4">
                 ...
                 ArrayList<Estoque> listaEstoque = new EstoqueDAO().getEstoques();
                    ...
                    for(int i = 0; i < listaEstoque.size(); i++){
                        out.println("<tr>");
                        out.println("<th scope='row'>" + listaEstoque.get(i).getNome_produto()+"</th >");
                        out.println("<td>" + listaEstoque.get(i).getCod_produto()+ "</td>");
                        out.println("<td>" + listaEstoque.get(i).getDescricao()+ "</td>");
                        out.println("<td>" + listaEstoque.get(i).getQuantidade()+ "</td>");
                        out.println("<td>" + listaEstoque.get(i).getValorEstoque()+ "</td>");
                        out.println("</tr>");
                    }
%> 
                        </tbody>
